...
function getURLTokenBitSet(): CompressedCodePointSet{
    ...
    // re-add back null because that counts as the unicode
    // replacement character, which is allowed in the spec
    $set->add(cp("\0"));

    // disallowed by spec. because if found at offset 0,
    // it would represent a functiontoken
