...
require(__DIR__ . "/dev/assertMatch.inc.php");
require(__DIR__ . "/dev/assertNotMatch.inc.php");
require(__DIR__ . "/dev/cartesianProduct.inc.php");
require(__DIR__ . "/dev/cp.inc.php");
require(__DIR__ . "/dev/getBoundariesCount.inc.php");
require(__DIR__ . "/dev/getBoundariesRange.inc.php");
require(__DIR__ . "/dev/getCodePointsFromRanges.inc.php");
...
require(__DIR__ . "/tests/Tokenizer/makeEatEscapeFunctionFromEscapeList.inc.php");
require(__DIR__ . "/tests/Tokenizer/makePiecesSample.inc.php");
