...
require(__DIR__ . "/tests/Parser/getNodeStream.inc.php");
require(__DIR__ . "/tests/Parser/getToken.inc.php");
require(__DIR__ . "/tests/Parser/getTokens.inc.php");
require(__DIR__ . "/tests/Parser/stringifyNodes.inc.php");
require(__DIR__ . "/tests/Parser/ComponentValues/getTokenStream.inc.php");
require(__DIR__ . "/tests/Parser/ComponentValues/stringifyTokens.inc.php");
